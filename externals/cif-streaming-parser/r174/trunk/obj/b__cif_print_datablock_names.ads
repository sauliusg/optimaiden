...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cif_print_datablock_names" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2edc3e96#;
   pragma Export (C, u00001, "cif_print_datablock_namesB");
