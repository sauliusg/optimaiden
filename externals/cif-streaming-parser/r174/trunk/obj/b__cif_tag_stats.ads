...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cif_tag_stats" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#76bd4432#;
   pragma Export (C, u00001, "cif_tag_statsB");
   ...
   u00007 : constant Version_32 := 16#4b91ffca#;
   ...
   u00024 : constant Version_32 := 16#2a95d23d#;
   pragma Export (C, u00024, "system__storage_elementsB");
   u00025 : constant Version_32 := 16#e939c75c#;
   ...
   u00187 : constant Version_32 := 16#117102c2#;
   pragma Export (C, u00187, "cif_datablock_tagB");
   u00188 : constant Version_32 := 16#fb9e6f14#;
   pragma Export (C, u00188, "cif_datablock_tagS");
   u00189 : constant Version_32 := 16#e3ec85fd#;
   pragma Export (C, u00189, "ada__containers__hash_tablesS");
   u00190 : constant Version_32 := 16#eab0e571#;
   pragma Export (C, u00190, "ada__containers__prime_numbersB");
   u00191 : constant Version_32 := 16#45c4b2d1#;
   pragma Export (C, u00191, "ada__containers__prime_numbersS");
   u00192 : constant Version_32 := 16#52aa515b#;
   pragma Export (C, u00192, "ada__strings__hashB");
   u00193 : constant Version_32 := 16#1121e1f9#;
   pragma Export (C, u00193, "ada__strings__hashS");
   ...
   u00202 : constant Version_32 := 16#7418cb14#;
   pragma Export (C, u00202, "system__strings__stream_opsB");
   u00203 : constant Version_32 := 16#278c9056#;
   pragma Export (C, u00203, "system__strings__stream_opsS");
   u00204 : constant Version_32 := 16#34d6af4f#;
   pragma Export (C, u00204, "cif_error_messagesS");
   u00205 : constant Version_32 := 16#68b71c58#;
   pragma Export (C, u00205, "cif_ioB");
   u00206 : constant Version_32 := 16#b779c1e0#;
   pragma Export (C, u00206, "cif_ioS");
   u00207 : constant Version_32 := 16#68d40d38#;
   pragma Export (C, u00207, "cif_streaming_parserB");
   u00208 : constant Version_32 := 16#253820a4#;
   pragma Export (C, u00208, "cif_streaming_parserS");
   u00209 : constant Version_32 := 16#af7aa5ba#;
   pragma Export (C, u00209, "ada__real_timeB");
   u00210 : constant Version_32 := 16#a00d3370#;
   pragma Export (C, u00210, "ada__real_timeS");
   u00211 : constant Version_32 := 16#521b9a38#;
   pragma Export (C, u00211, "system__taskingB");
   u00212 : constant Version_32 := 16#1ca18b56#;
   pragma Export (C, u00212, "system__taskingS");
   u00213 : constant Version_32 := 16#e850091f#;
   pragma Export (C, u00213, "system__task_primitivesS");
   u00214 : constant Version_32 := 16#848a1fe0#;
   pragma Export (C, u00214, "system__os_interfaceB");
   u00215 : constant Version_32 := 16#1952b102#;
   pragma Export (C, u00215, "system__os_interfaceS");
   u00216 : constant Version_32 := 16#fe266d85#;
   pragma Export (C, u00216, "system__linuxS");
   u00217 : constant Version_32 := 16#91a356f8#;
   pragma Export (C, u00217, "system__task_primitives__operationsB");
   u00218 : constant Version_32 := 16#1e811718#;
   pragma Export (C, u00218, "system__task_primitives__operationsS");
   u00219 : constant Version_32 := 16#9ebeb40e#;
   pragma Export (C, u00219, "system__interrupt_managementB");
   u00220 : constant Version_32 := 16#50dc425b#;
   pragma Export (C, u00220, "system__interrupt_managementS");
   u00221 : constant Version_32 := 16#fe2ee843#;
   pragma Export (C, u00221, "system__multiprocessorsB");
   u00222 : constant Version_32 := 16#7ac130cb#;
   pragma Export (C, u00222, "system__multiprocessorsS");
   u00223 : constant Version_32 := 16#4ee862d1#;
   pragma Export (C, u00223, "system__task_infoB");
   u00224 : constant Version_32 := 16#f415468c#;
   pragma Export (C, u00224, "system__task_infoS");
   u00225 : constant Version_32 := 16#5d6b44f2#;
   pragma Export (C, u00225, "system__tasking__debugB");
   u00226 : constant Version_32 := 16#4bb799fc#;
   pragma Export (C, u00226, "system__tasking__debugS");
   u00227 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00227, "system__concat_3B");
   u00228 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00228, "system__concat_3S");
   u00229 : constant Version_32 := 16#602bc0ef#;
   pragma Export (C, u00229, "system__img_lliS");
   u00230 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00230, "system__wid_lluS");
   u00231 : constant Version_32 := 16#e5d09b61#;
   pragma Export (C, u00231, "system__stack_usageB");
   u00232 : constant Version_32 := 16#371a1ff7#;
   pragma Export (C, u00232, "system__stack_usageS");
   u00233 : constant Version_32 := 16#b2953bd2#;
   pragma Export (C, u00233, "cexceptions_adaS");
   u00234 : constant Version_32 := 16#7469f608#;
   pragma Export (C, u00234, "cif_options_adaS");
   u00235 : constant Version_32 := 16#22d1a9c4#;
   pragma Export (C, u00235, "system__tasking__protected_objectsB");
   u00236 : constant Version_32 := 16#a211a246#;
   pragma Export (C, u00236, "system__tasking__protected_objectsS");
   u00237 : constant Version_32 := 16#6503b451#;
   pragma Export (C, u00237, "system__soft_links__taskingB");
   u00238 : constant Version_32 := 16#917fc4d2#;
   pragma Export (C, u00238, "system__soft_links__taskingS");
   u00239 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00239, "ada__exceptions__is_null_occurrenceB");
   u00240 : constant Version_32 := 16#e2b3c9ca#;
   pragma Export (C, u00240, "ada__exceptions__is_null_occurrenceS");
   u00241 : constant Version_32 := 16#95ec39a0#;
   pragma Export (C, u00241, "system__tasking__protected_objects__operationsB");
   u00242 : constant Version_32 := 16#b9523220#;
   pragma Export (C, u00242, "system__tasking__protected_objects__operationsS");
   u00243 : constant Version_32 := 16#49c205ec#;
   pragma Export (C, u00243, "system__restrictionsB");
   u00244 : constant Version_32 := 16#fb7e94ed#;
   pragma Export (C, u00244, "system__restrictionsS");
   u00245 : constant Version_32 := 16#c1f64448#;
   pragma Export (C, u00245, "system__tasking__entry_callsB");
   u00246 : constant Version_32 := 16#d453bba7#;
   pragma Export (C, u00246, "system__tasking__entry_callsS");
   u00247 : constant Version_32 := 16#bd80a609#;
   pragma Export (C, u00247, "system__tasking__initializationB");
   u00248 : constant Version_32 := 16#4b32ba0f#;
   pragma Export (C, u00248, "system__tasking__initializationS");
   u00249 : constant Version_32 := 16#d5634deb#;
   pragma Export (C, u00249, "system__tasking__task_attributesB");
   u00250 : constant Version_32 := 16#fb86dea5#;
   pragma Export (C, u00250, "system__tasking__task_attributesS");
   u00251 : constant Version_32 := 16#472ea76a#;
   pragma Export (C, u00251, "system__tasking__protected_objects__entriesB");
   u00252 : constant Version_32 := 16#7daf93e7#;
   pragma Export (C, u00252, "system__tasking__protected_objects__entriesS");
   u00253 : constant Version_32 := 16#91c1d62b#;
   pragma Export (C, u00253, "system__tasking__queuingB");
   u00254 : constant Version_32 := 16#f5dd32a7#;
   pragma Export (C, u00254, "system__tasking__queuingS");
   u00255 : constant Version_32 := 16#0044c253#;
   pragma Export (C, u00255, "system__tasking__utilitiesB");
   u00256 : constant Version_32 := 16#02b4e0a4#;
   pragma Export (C, u00256, "system__tasking__utilitiesS");
   u00257 : constant Version_32 := 16#4857f38e#;
   pragma Export (C, u00257, "system__tasking__rendezvousB");
   u00258 : constant Version_32 := 16#e26d829c#;
   pragma Export (C, u00258, "system__tasking__rendezvousS");
   u00259 : constant Version_32 := 16#cdbfef8a#;
   pragma Export (C, u00259, "system__tasking__stagesB");
   u00260 : constant Version_32 := 16#fce19d8e#;
   pragma Export (C, u00260, "system__tasking__stagesS");
   u00261 : constant Version_32 := 16#2d236812#;
   pragma Export (C, u00261, "ada__task_initializationB");
   u00262 : constant Version_32 := 16#d7b0c315#;
   pragma Export (C, u00262, "ada__task_initializationS");
   u00263 : constant Version_32 := 16#d3011874#;
   pragma Export (C, u00263, "datablock_queueS");
