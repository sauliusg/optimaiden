...
package Cif_Streaming_Parser is
  ...
  procedure Dequeue_Datablock (CDA : out Controlled_Datablock) with
...
private
  ...
  function Parse_Cif_From_File_Error_Code return Error_Code_T_Access
    with Import => True,
        Convention => C,
        External_Name => "parse_cif_from_file_error_code";
