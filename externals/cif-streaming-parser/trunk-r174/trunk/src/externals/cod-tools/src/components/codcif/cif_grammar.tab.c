...
#line 8 "src/externals/codcif/cif_grammar.y"
...
void cif1_init_parser(void)
{
    cif_cc = NULL;
    px = NULL;
}
 
void cif1_display_static_parser_variables(void)
{
...
#line 127 "src/externals/codcif/cif_grammar.tab.c"
...
#ifndef YY_CIF_SRC_EXTERNALS_CODCIF_CIF_GRAMMAR_TAB_H_INCLUDED
# define YY_CIF_SRC_EXTERNALS_CODCIF_CIF_GRAMMAR_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#line 58 "src/externals/codcif/cif_grammar.y"

    #include <cif_compiler.h>

#line 174 "src/externals/codcif/cif_grammar.tab.c"
...
union YYSTYPE
{
#line 62 "src/externals/codcif/cif_grammar.y"

    char *s;
    typed_value *typed_value;

#line 204 "src/externals/codcif/cif_grammar.tab.c"
...
#endif /* !YY_CIF_SRC_EXTERNALS_CODCIF_CIF_GRAMMAR_TAB_H_INCLUDED  */
...
{
       0,    92,    92,    93,    94,    95,    96,    97,   101,   116,
     123,   124,   128,   145,   144,   164,   165,   169,   170,   174,
     193,   233,   234,   239,   240,   244,   245,   249,   257,   298,
     299,   333,   332,   361,   372,   386,   394,   406,   405,   419,
     420,   421,   425,   429,   433,   440,   493,   495
};
#endif
...
{
      45,    -3,   -25,    -3,   -25,   -25,   -25,   -25,   -25,   -25,
     -25,    20,    19,    22,    22,   -25,     7,    15,   -25,   -25,
     -25,   -25,   -25,   -25,   -25,   -25,    -3,   -25,    32,    -3,
      17,   -25,    22,   -25,   -25,    22,     7,   -25,     7,   -25,
      28,   -25,    -3,   -25,    53,   -25,     7,   -25,   -25,   -25,
      -3,   -25,   -25
};
...
{
     -25,   -25,   -25,     5,   -25,   -25,   -11,    -2,   -25,     1,
     -25,   -24,   -25,    11,   -25,   -25,   -25,   -25,   -25,   -25,
       0,   -25,   -25,   -25
};
...
{
      22,    17,    34,    29,    41,     5,     6,     7,     8,     9,
      10,     2,    33,     3,     4,   -12,    48,    32,   -12,    35,
      31,    34,     1,    43,    34,     1,    39,     5,     6,     7,
       8,     9,    10,    47,     3,     4,    46,    45,     3,     4,
      42,     0,    39,     0,    51,     0,     0,    45,     1,     2,
      52,     3,     4,     5,     6,     7,     8,     9,    10,    49,
       0,     5,     6,     7,     8,     9,    10
};

static const yytype_int8 yycheck[] =
{
       0,     0,    13,     3,    28,     8,     9,    10,    11,    12,
      13,     4,    12,     6,     7,     0,    40,    12,     3,    14,
       0,    32,     3,     6,    35,     3,    26,     8,     9,    10,
      11,    12,    13,     5,     6,     7,    38,    36,     6,     7,
      29,    -1,    42,    -1,    44,    -1,    -1,    46,     3,     4,
      50,     6,     7,     8,     9,    10,    11,    12,    13,     6,
      -1,     8,     9,    10,    11,    12,    13
};
...
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep)
{
  ...
  switch (yytype)
    {
    case 3: /* _DATA_  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1157 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 4: /* _SAVE_HEAD  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1163 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 6: /* _TAG  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1169 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 7: /* _LOOP_  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1175 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 8: /* _DQSTRING  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1181 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 9: /* _SQSTRING  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1187 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 10: /* _UQSTRING  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1193 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 11: /* _TEXT_FIELD  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1199 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 12: /* _INTEGER_CONST  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1205 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 13: /* _REAL_CONST  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1211 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 22: /* data_block_head  */
#line 67 "src/externals/codcif/cif_grammar.y"
            { freex(((*yyvaluep).s)); }
#line 1217 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 27: /* cif_value_list  */
#line 68 "src/externals/codcif/cif_grammar.y"
            { delete_typed_value(((*yyvaluep).typed_value)); }
#line 1223 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 34: /* cif_value  */
#line 68 "src/externals/codcif/cif_grammar.y"
            { delete_typed_value(((*yyvaluep).typed_value)); }
#line 1229 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 35: /* string  */
#line 68 "src/externals/codcif/cif_grammar.y"
            { delete_typed_value(((*yyvaluep).typed_value)); }
#line 1235 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 36: /* textfield  */
#line 68 "src/externals/codcif/cif_grammar.y"
            { delete_typed_value(((*yyvaluep).typed_value)); }
#line 1241 "src/externals/codcif/cif_grammar.tab.c"
        break;

    case 37: /* number  */
#line 68 "src/externals/codcif/cif_grammar.y"
            { delete_typed_value(((*yyvaluep).typed_value)); }
#line 1247 "src/externals/codcif/cif_grammar.tab.c"
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
  case 8:
#line 102 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1530 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 9:
#line 117 "src/externals/codcif/cif_grammar.y"
        {
            delete_typed_value( (yyvsp[0].typed_value) );
        }
#line 1538 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 12:
#line 129 "src/externals/codcif/cif_grammar.y"
        {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
...
#line 1558 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 13:
#line 145 "src/externals/codcif/cif_grammar.y"
        {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, 
...
#line 1578 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 19:
#line 175 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1601 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 20:
#line 194 "src/externals/codcif/cif_grammar.y"
        {
            if( isset_fix_errors( cif_cc ) ||
...
#line 1642 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 27:
#line 250 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1654 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 28:
#line 258 "src/externals/codcif/cif_grammar.y"
            {
                assert_datablock_exists( cif_cc, px );
                if( isset_fix_errors( cif_cc ) ||
                    isset_fix_string_quotes( cif_cc ) ) {
...
#line 1696 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 30:
#line 300 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1730 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 31:
#line 333 "src/externals/codcif/cif_grammar.y"
       {
           assert_datablock_exists( cif_cc, px );
...
#line 1741 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 32:
#line 340 "src/externals/codcif/cif_grammar.y"
       {
...
#line 1764 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 33:
#line 362 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1779 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 34:
#line 373 "src/externals/codcif/cif_grammar.y"
        {
            ssize_t tag_nr = cif_tag_index( cif_compiler_cif( cif_cc ), (yyvsp[0].s) );
            if( tag_nr != -1 ) {
                yyerror_token( cif_cc, cxprintf( "tag %s appears more than once", (yyvsp[0].s) ),
...
#line 1794 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 35:
#line 387 "src/externals/codcif/cif_grammar.y"
        {
...
#line 1806 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 36:
#line 395 "src/externals/codcif/cif_grammar.y"
        {
            cif_compiler_increase_loop_values( cif_cc );
            cif_push_loop_cifvalue( cif_compiler_cif( cif_cc ),
                                    typed_value_value( (yyvsp[0].typed_value) ), px );
...
#line 1818 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 37:
#line 406 "src/externals/codcif/cif_grammar.y"
        {
            assert_datablock_exists( cif_cc, px );
            cif_start_save_frame( cif_compiler_cif( cif_cc ), /* name = */ (yyvsp[0].s), px );
            freex( (yyvsp[0].s) );
        }
#line 1828 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 38:
#line 413 "src/externals/codcif/cif_grammar.y"
        {
            cif_finish_save_frame( cif_compiler_cif( cif_cc ) );
        }
#line 1836 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 42:
#line 426 "src/externals/codcif/cif_grammar.y"
        {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[0].s), CIF_SQSTRING, px ), px );
        }
#line 1844 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 43:
#line 430 "src/externals/codcif/cif_grammar.y"
        {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[0].s), CIF_DQSTRING, px ), px );
        }
#line 1852 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 44:
#line 434 "src/externals/codcif/cif_grammar.y"
        {
            (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[0].s), CIF_UQSTRING, px ), px );
        }
#line 1860 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 45:
#line 441 "src/externals/codcif/cif_grammar.y"
        {
          char *text = (yyvsp[0].s);
...
#line 1914 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 46:
#line 494 "src/externals/codcif/cif_grammar.y"
        { (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[0].s), CIF_FLOAT, px ), px ); }
#line 1920 "src/externals/codcif/cif_grammar.tab.c"
    break;

  case 47:
#line 496 "src/externals/codcif/cif_grammar.y"
        { (yyval.typed_value) = typed_value_from_value( new_value_from_scalar( (yyvsp[0].s), CIF_INT, px ), px ); }
#line 1926 "src/externals/codcif/cif_grammar.tab.c"
    break;


#line 1930 "src/externals/codcif/cif_grammar.tab.c"
...
#line 499 "src/externals/codcif/cif_grammar.y"
