...
package Cif_Datablock is
  ...
  type Counted_Datablock_Access is access Counted_Datablock;
  
  type Controlled_Datablock is
  new Ada.Finalization.Controlled with record
    Access_Datablock : Counted_Datablock_Access;
  end record;

  overriding procedure Initialize (Item : in out Controlled_Datablock);

  overriding procedure Adjust (Item : in out Controlled_Datablock);

  overriding procedure Finalize (Item : in out Controlled_Datablock);

  function Create_Controlled_Datablock
   (DA : in Datablock_Access) return Controlled_Datablock;
  ...
  function Get_Datablock_Name (CDA : Controlled_Datablock) return String;

  function Get_Datablock_Name (CDA : Datablock_Access) return String;

  procedure Print_Datablock (CDA : Controlled_Datablock);
  ...
  function Get_Tag_Name (CDA : in Controlled_Datablock; TI : Integer)
    return String;
